-- =====================================================================
-- Seata 建表脚本
-- 1) Seata 服务端所需表（独立 seata 库）
-- 2) AT 模式要求每个参与分布式事务的业务库都有 undo_log 表
-- 该脚本同时被 docker/mysql/db/seata.sql 引用，由 MySQL 初始化挂载执行。
-- =====================================================================
...
-- ---------------- 业务库 undo_log（业务库统一为 vctgo_platform；配置库 vhcp_config 为 Nacos 配置库，不参与分布式事务） ----------------
